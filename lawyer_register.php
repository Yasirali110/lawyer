					...
					<div class="col-md-6">
						<form  action="lawyer_registation.php"  method="post" enctype="multipart/form-data"  id="validateForm">
							...
							<div class="form-group">
								<label for="num">Set Password</label>
								<input type="text" class="form-control" name="password" id="password" placeholder="Set Password">
							</div>
							
							<div class="form-group">
								<label for="num">Confirm Password</label>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-3">
									...
									<option value="nasiarabad">nasiarabad</option>
				...
				fields: {
					...
					password: {
						validators: {
							stringLength: {
								min: 8,
								message: 'Password Must be 8 letter or greater Digit',
							},
							notEmpty: {
