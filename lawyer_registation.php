<header>
	...
	<script>
		function MySucessFn(){
			swal({
				title: "Dear Lawyer...Your Registration Sucessfully Complete!",
				text: "",
				type: "success",
		...
		function MyCheckFn(){
			swal({
				title: "Sorry Lawyer!! Password is not match to Confirm",
				text: "",
				type: "warning",
			...
			window.load = function(){
				window.location='./lawyer_registation.php';
			});
		}
	</script>
</header>
<?php
	...
	if($okFlag){
		...
		if ($password != $confirmPassword) {
			echo "<script type= 'text/javascript'>PassWrong();</script>";
			exit;
		} else {
			$password = $password;
		}
