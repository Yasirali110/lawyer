		...
		<body>
														...
														<div class="form-row">
															...
															<div class="form-group col-md-3">
																...
																<select id="city" name="city" class="form-control">
																	<option value=" " selected>Choose...</option>
																	<option value="Dhaka" <?php if ($row['city']=='Larkana'){echo "selected";}?>>Larkana</option>
																	<option value="Chittagong" <?php if ($row['city']=='qambar'){echo "selected";}?>>qambar</option>
																	<option value="Sylhet" <?php if ($row['city']=='nasirabad'){echo "selected";}?>>nasirabad</option>
																	<option value="Barishal" <?php if ($row['city']=='sukkur'){echo "selected";}?>>sukkur</option>
																	<option value="Khulna" <?php if ($row['city']=='dadu'){echo "selected";}?>>dadu</option>
																	<option value="Mymensingh" <?php if ($row['city']=='meher'){echo "selected";}?>>meher</option>
																	<option value="Rajshahi" <?php if ($row['city']=='karachi'){echo "selected";}?>>karachi</option>
			...
			<footer>
				<div class="container">
					<div class="row">
						<div class="col">
							<h5>All rights reserved by HAMZI BALOCH 2019</h5>
						</div>
					</div>
				</div>
			</footer>
